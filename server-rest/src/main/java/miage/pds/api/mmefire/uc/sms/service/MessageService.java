...
// creer un message en BD
	private void addMessage(MessageDTO messageDto) {
		...
		Message message = new Message(messageDto.content, messageDto.sender,
				messageDto.recipient, messageDto.date);
...
// permet de recuperer un liste de message � partir de l'id du contact passe en parametre
	private List<Message> getMessagesForContact(String contactID){
