package pds.isintheair.fr.crmtab.crv.test;
...
import pds.isintheair.fr.crmtab.crv.view.CreateCrvActivity;
...
public class CreateCrvActivityTest extends ActivityInstrumentationTestCase2<CreateCrvActivity> {
    ...
    public CreateCrvActivityTest() {
        super(CreateCrvActivity.class);
    }
